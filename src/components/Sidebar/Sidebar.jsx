              ...
              return (
                <div key={index} onClick={() => loadPrompt(item)} className="recent-entry">
                  ...
                  <img 
                    ...
                    src={assets.trash} 
                    onClick={(e) => {
                        e.stopPropagation(); // Prevents loading the prompt when deleting
                        deletePrompt(index);
                    }} 
                    alt="delete" 
                  />
  ...
  return (
    <div className="sidebar">
      <div className="sidebar_top">
        ...
        {extended ? (
          <div className="recent">
            <p className="recent_heading">Recent</p>
      ...
      <div className="sidebar_bottom">
        <div className="bottom_icons recent-chat">
          <img src={assets.question_icon} alt="" className="history" />
          {extended ? <p>Help</p> : null}
        </div>
        <div className="bottom_icons recent-chat">
          <img src={assets.history_icon} alt="" className="upgrade" />
          {extended ? <p>Activity</p> : null}
        </div>
        <div className="bottom_icons recent-chat">
