        ...
        <div className="main-bottom">
          ...
          <form onSubmit={handleFormSubmit} className="search-box">
            ...
            <div>
              ...
              {input ? (
                /* 2. Using an image inside a button with type="submit" 
                   allows the form to trigger correctly */
                <button
                  type="submit"
                  style={{
                    border: "none",
    ...
    <div className="main">
      ...
      <div className="main-container">
        ...
        <div className="cards">
          ...
          <div className="card">
            <p>Breifly summurize this concept: urban planning</p>
            <img src={assets.bulb_icon} alt="" />
          </div>
          <div className="card">
            <p>Brainstorm team bonding activities for our work retreat</p>
      ...
      <div className="main-bottom">
        ...
        <p className="bottom-info">
          Powered by GPT-4 & DALL·E 3. Free Research Preview.
        </p>
      </div>
    </div>
  );
